---
layout: page
title: Passenger-Freight Separation with Rooftop Transfer Locker
description: Hybrid cargo-elevator operations for vertical congestion management in high-rise buildings, separating passenger and parcel flows with a rooftop transfer locker.
...
*Sun, Qi-Hang and Guo, Ren-Yong and Zhao, Shixin*, submitted to **Transportation Research Part E: Logistics and Transportation Review**.
...
{% include figure.liquid loading="eager" path="assets/img/vertical_transportation_illustration.jpg" class="img-fluid rounded z-depth-1" caption="Illustration of rooftop transfer locker operations" %}
